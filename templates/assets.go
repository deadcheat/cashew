...
var Assets = goblet.NewFS(
	...
	map[string]*goblet.File{
		...
		"/files/login/logout.html":            goblet.NewFile("/files/login/logout.html", []byte(_Assetsdd409359cf11595b87d49b50aff81e478fecca74), 0x1a4, time.Unix(1547689407, 1547689407351803515)),
