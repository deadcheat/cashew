...
var Assets = goblet.NewFS(
	...
	map[string]*goblet.File{
		...
		"/files/login/login.html":             goblet.NewFile("/files/login/login.html", []byte(_Assetsde4243da79c0324a6719ff4a9316d4a31ecacdf9), 0x1a4, time.Unix(1547861190, 1547861190419000000)),
