...
var Assets = goblet.NewFS(
	...
	map[string]*goblet.File{
		...
		"/files/login/index.html":             goblet.NewFile("/files/login/index.html", []byte(_Assetsd29f119cb8a3017c01e0ffabccfaac8408934e6f), 0x1a4, time.Unix(1544754232, 1544754232109492289)),
