...
var Assets = goblet.NewFS(
	...
	map[string]*goblet.File{
		...
		"/files/login":                        goblet.NewFile("/files/login", nil, 0x800001ed, time.Unix(1537798571, 1537798571006194753)),
		"/files/login/index.html":             goblet.NewFile("/files/login/index.html", []byte(_Assetsd29f119cb8a3017c01e0ffabccfaac8408934e6f), 0x1a4, time.Unix(1547644425, 1547644425999466803)),
		"/files/login/logout.html":            goblet.NewFile("/files/login/logout.html", []byte(_Assetsdd409359cf11595b87d49b50aff81e478fecca74), 0x1a4, time.Unix(1544754208, 1544754208589260502)),
